...
public class OldPanel extends SurfaceView implements SurfaceHolder.Callback {
	...
	public void gameOver()
	{
		...
		gameOverSprite= new ClickableSprite( getResources(), (int) OldPanel.mWidth/2, (int) OldPanel.mHeight/2, gameoverbitmap, 1 );
	...
	public void showMenu()
	{
		...
		menuSprite = new ClickableSprite(getResources(), (int) 100, (int) 200, mimgarray, 1);
		menuSprite.setAction(ClickableSprite.START_LEVEL_ONE);

		ClickableSprite menuSprite2 = new ClickableSprite(getResources(), (int) 400, (int) 200, mimgarray, 1);
		menuSprite2.setAction(ClickableSprite.START_LEVEL_TWO);
		
		ClickableSprite menuSprite3 = new ClickableSprite(getResources(), (int) 600, (int) 200, mimgarray, 1);
	...
	private void gameStartLevelThree(Context context) {
		...
		ClickableSprite ns = new ClickableSprite( getResources(), 100, 200, projBmp, 3);
		ns.setAction(ClickableSprite.CHOOSE_PROJECTILE);
		ns.setPersistent(true);
		gameUIList.add(ns);
		
		Bitmap[] sb = {swordBmp};
		ClickableSprite ss = new ClickableSprite( getResources(), 200, 200, sb, 3);
		...
		{
			ClickableSprite hs = new ClickableSprite( getResources(), 100 + 100*i, 100, health, 2);
